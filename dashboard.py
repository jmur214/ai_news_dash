...
# Convert JSON strings back to dicts/lists safely
...
# Compute dominant_category for initial df
...
# Layout
app.layout = html.Div([
    html.H1("OSINT News Dashboard"),
    
    html.Label("Select Categories:"),
    dcc.Dropdown(
        id='category-dropdown',
        options=[{'label': cat, 'value': cat} for cat in df['dominant_category'].unique()],
        multi=True,
    ...
    html.H2("Timeline of Flagged Events"),
    dcc.Graph(id='timeline-graph'),
    
    html.H2("Global Threat Map"),
